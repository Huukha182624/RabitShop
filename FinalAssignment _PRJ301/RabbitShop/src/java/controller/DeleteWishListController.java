...
public class DeleteWishListController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        DAO dao = new DAO();
        dao.removeFromWishlist(uId, pName);
        String removed = "The mobile "+ pName + " is removed from your wishlist!!";
        request.setAttribute("removed", removed);
        request.getRequestDispatcher("WistListController").forward(request, response);
    }
