...
public class AddToCartController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ProductDTO p = new ProductDTO(w.getRabbitId(),w.getRabbitName(), w.getPrice(), 1, w.getImg(),w.getDescription());
            ...
            String done = "The " + w.getRabbitName()+ " has been add to your cart!!";
