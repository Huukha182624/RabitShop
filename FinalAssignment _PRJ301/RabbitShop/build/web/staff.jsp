...
<html>
    ...
    <center>
        <jsp:include page="headershop.jsp"/>
            ...
            <div class="form-container">
                <form action="addrabbit.jsp">
                    Add new rabbit &nbsp; <input type="submit" value="Add rabbit"> &nbsp; <i class="fa-solid fa-plus"></i>
                </form>
                <form action="MainController" method="post">
                    Search rabbit (ID or Name) &nbsp;  <input type="text" name="search" value="<%= search%>" > &nbsp; 
                    <input type="submit" name="action" value="Search rabbit"> &nbsp;  <i class="fa-solid fa-magnifying-glass"></i> <br> <br><br>
                </form>
            </div>
            <%
            ...
            <table>
                ...
                <tr>
                    <td><%= i.getRabbitId()%></td>
                    <td><img class="rabbitimg" src="img/<%= i.getImg()%>"></td>
                    <td><%= i.getDescription()%></td>
                    <td><%= i.getPrice()%> $</td>
                    <td><%= i.getRabbitName()%></td>
                    <td><%= i.getYearOfProduction()%></td>
                    <td><%= i.getQuantity()%></td>
                    <td><%= i.isNotSale() ? 1 : 0%></td>
                    <td>
                        <a href="#" onclick="doDelete('<%= i.getRabbitId()%>')">Delete</a> &nbsp; &nbsp; 
                        <a href="UpdateRabbitController?rabbitId=<%= i.getRabbitId()%>">Update</a>
                    </td>
                </tr>
                <% }
                } %>
            ...
            <div class="imgsetting">
                ...
                %>    
                <img class="rabbitimg" src="img/<%=i.getImg()%>"> 
                <%
                        }
                    }
                %>
    ...
    <script type="text/javascript">
        function doDelete(rabbitId) {
            if (confirm("Are you sure to delete this rabbit with id:" + rabbitId + "?")) {
                window.location = "DeleteController?rabbitId=" + rabbitId + "&action=deleterabbit";
            }
        }
    </script>
    <br> <br>
