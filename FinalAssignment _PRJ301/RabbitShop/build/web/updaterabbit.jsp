...
<html>
    ...
    <body>
        <%
            RabbitDTO w = null;
            if (request.getAttribute("rabbit") != null) {
                w = (RabbitDTO) request.getAttribute("rabbit");
            }
        %>
        <div class="container"> 
            <div class="row"> 
            ...
            <div class="row"> 
                <div class="col-md-12">
                    <div class="form">
                        ...
                        <form action="UpdateRabbitController" method="Post">
                            <div class="input"> 
                            ...
                            <input type="hidden" name="rabbitId" value="<%= w.getRabbitId()%>"> <br>
                            <input type="hidden" name="rabbitName" value="<%= w.getRabbitName()%>"> <br>
                            <input type="hidden" name="yearOfProduction" value="<%= w.getYearOfProduction()%>"> <br>
                            <input type="submit" name="action" value="Update rabbit"> &nbsp <i class="fa-solid fa-file-circle-check"></i>
                            </div>
                        </form>
                    </div>
                </div>
