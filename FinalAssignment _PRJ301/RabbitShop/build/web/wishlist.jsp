                ...
                <div class="col-md-12">
                    ...
                    <table border="1px" width="80%" style="background-color: cornsilk">
                        ...
                        <form action="MainController"> 
                            <tr>
                                <td> <%= i.getuId()%> </td>
                                <td> <img class="rabbitimg" src="img/<%=i.getImage()%>"> </td>
                                <td> <%= i.getpName()%> </td>
                            ...
                            <input type="hidden" name="rabbitID" value="<%= i.getpId()%>">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <a class="back" href="MainController?action=Shop%20again"> Go back </a>
                </div>
            </div>
        </div>
        <br>
